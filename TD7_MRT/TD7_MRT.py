...
class Agent(object):
    def __init__(self, state_dim, action_dim, max_action, offline=False, mrt=False, mrt_interval=1000, hp=Hyperparameters()):
    ...
    def train(self):
        ...
        # if self.mrt:
        #     rt_loss = self.mse_loss(Q.detach(), Q_target+bias)
        #
        #     # rt_loss = (Q.detach()-Q_target + reward.detach() - reward).abs().mean()
        #
